...
export class KeyWords
{
    constructor()
    {
        this.keyWordsCodes = new Map([
            ...
            ['static', SymbolsCodes.staticSy],
            ['public', SymbolsCodes.publicSy],
            ['class', SymbolsCodes.classSy],
            ['private', SymbolsCodes.privateSy],
            ['protected', SymbolsCodes.protectedSy],
            ['published', SymbolsCodes.publishedSy],
            ['strict', SymbolsCodes.strictSy],
